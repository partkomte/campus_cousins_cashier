    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">DPU</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">DPU</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Dr DY Patil Institute of Technology is governed by Indus 
                        Global Educational & Welfare Society which was founded 
                        in 1998 by a group of industrialists and educationalists
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-envelope"></i> <p>rohankumbhar</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>pimpri pune</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>9999999999999999</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Rohan Kumbhar</a></div>
                </main>
            </section>
        `;
        })
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://engg.dypvp.edu.in/" target="_blank">DPU Pimpri</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-map-marker-alt"></i> <p>DPU Pimpri, pune</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>99999999999999999999999</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
